 ...
 * @author Takeshi
 */
public class qtd5 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(qtd5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
